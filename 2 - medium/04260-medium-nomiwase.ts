...
type All<T extends string, U extends string = StringToUnion<T>> =
  U extends never
  ? never
  : U | `${U}${All<Exclude<StringToUnion<T> , U>>}`

type AllCombinations<T extends string> = All<T> | ''
