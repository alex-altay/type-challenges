...
declare function defineStore<
  ...
  Getters,
  Actions,
  GettersReturn = { [P in keyof Getters]: Getters[P] extends (...args: unknown[]) => infer R ? R : never}
>(store: {
  id: string
  state?: () => State,
  getters?: Getters & ThisType<Readonly<State & GettersReturn>>
  actions?: Actions & ThisType<State & Actions>
}): 
  State & GettersReturn & Actions
